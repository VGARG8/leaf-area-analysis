...
def openphoto():
    ...
    fileName = askopenfilename(initialdir=r'C:\Users\Vaibhav garg\Desktop', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = r"F:\Vaibhav garg\Downloads\PlantDiseaseDetection-master\PlantDiseaseDetection-master\test\test"
